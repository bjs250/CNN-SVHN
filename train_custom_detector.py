...
if __name__ == "__main__":
    ...
    print("============== train_custom_detector.py ==============")

    #  Class for digits, class for no digits
    num_classes = 2

    if 1:  # for Floydhub cloud computing
        training_dir = '/data/detect_train'
        testing_dir = '/data/detect_test'
        model_path = "/output/svhn-detector-model.hdf5"
        log_path = "/output/custom_detector_log.csv"
    if 0:  # For local machine
        training_dir = 'processed_data/detect_train'
        testing_dir = 'processed_data/detect_test'
        model_path = "models/svhn-detector-model-new.hdf5"
        log_path = "logs/custom_detector_log_new.csv"
